...
public class NotificationPermission : Microsoft.Maui.ApplicationModel.Permissions.BasePermission {
    public override Task<PermissionStatus> CheckStatusAsync() {
        ...
        UNUserNotificationCenter.Current.GetNotificationSettings((settings) => {
            PermissionStatus status = settings.AuthorizationStatus switch {
                UNAuthorizationStatus.Authorized => PermissionStatus.Granted, UNAuthorizationStatus.Denied => PermissionStatus.Denied,
